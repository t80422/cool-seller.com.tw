    ...
    <main class="container-wrap">
        <div class="container-main">
            ...
            <div class="tool-wrap">
                ...
                <div class="tool-btn">
                    <button class="btn-add" onClick="window.location.href='<?php echo url_to('Backend\ProductSC::create'); ?>'">新增</button>
                </div>
            </div>
            <!-- list -->
            <div class="list-wrap">
                    ...
                    <div class="list-main">
                        ...
                        <?php foreach($Datas as $data):	?>
                            <div class="list-row pr-2 pl-2">
								<div class="f-2">
                                    <figure class="prod-img" style="background-image: url('<?php  echo "/public/images/products/categories/".$data->psc_Image ?? "/image/backend/imgfile.png"; ?>');"></figure>
                                </div>
                                <div class="f-1"><?php echo $data->pmc_Name; ?></div>
                                <div class="f-1"><?php echo $data->psc_Name; ?></div>
                                <div class="f-1 ta-left"><?php echo $data->psc_Sort; ?></div>
                                <div class="f-1 ta-left"><?php echo $data->psc_Enabled==1 ? "顯示":"不顯示"; ?></div>
								<div class="f-1 ta-left"><?php echo $data->psc_CreateAt; ?></div>
                                <div class="f-1">
                                    <button class="btn-edit" onClick="location.href='<?php echo url_to('Backend\ProductSC::edit',$data->psc_Id);?>'"></button>
                                    <button class="btn-del" data-sn="<?php echo $data->psc_Id; ?>"></button>
                                </div>
                            </div>
                        <?php endforeach; ?>
                        <!-- <div class="list-row pr-2 pl-2">
        ...
        <script>
            ...
            $(function() {
                ...
                $(".popup-btn .btn-submit").on('click',function(){
                    location.href='<?php echo url_to('Backend\ProductSC::index'); ?>' + '/delitem/' + sn;
                })
            });
