            ...
            <div class="list-overflow">
                <div class="list-main">
                    <div class="list-title pr-2 pl-2">
                        <div class="f-1">圖檔</div>
                        <div class="f-1">名稱</div>
                        <div class="f-1">說明</div>
                    ...
                    <?php foreach ($datas as $data): ?>
                        <div class="list-row pr-2 pl-2">
                            <div class="f-1"><?= $data['pmc_ImageName'] ?></div>
                            <div class="f-1"><?= $data['pmc_Name'] ?></div>
                            <div class="f-1"><?= $data['pmc_Desc'] ?></div>
                            <div class="f-1"><?= $data['pmc_CreateAt'] ?></div>
                            <div class="f-1"><?= $data['pmc_UpdateAt'] ?></div>
                            <div class="f-1"><?= $data['pmc_Sort'] ?></div>
                            <div class="f-1">
                                <input type="checkbox" disabled <?= $data['pmc_Enabled'] == 1 ? 'checked' : '' ?>>
                            </div>
                            <div class="f-1">
                                <button class="btn-edit" onClick="location.href='<?= url_to($controller . '::edit_download', $data['pmc_Id']); ?>'"></button>
                                <button class="btn-del" data-sn="<?= $data['pmc_Id']; ?>"></button>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
