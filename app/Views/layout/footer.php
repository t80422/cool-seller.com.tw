        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="indurial-solution-text text-center">
            ...
            <span class="contactus-button2 text-center">
              <a href="/contact" class="submit">聯絡我們</a>
            </span>
          </div>
        </div>
      </div>
        ...
        <div class="sidebar-footer footer-columns footer-4-columns clearfix">
          <div
            ...
            <aside
              ...
              <a href="/about">查看更多 <i class="fa fa-angle-double-right"></i></a>
              <ul class="nav">
                <li>
          ...
          <div
            ...
            role="complementary">
            <aside id="ind_services-1" class="widget widget_ind_services widget-links">
