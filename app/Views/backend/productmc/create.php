...
<?php $this->section('content'); ?>
    ...
    <main class="container-wrap">
        <div class="container-main">
            <div class="form-wrap">
                <form action="<?php echo url_to('Backend\ProductMC::additem'); ?>" id="myForm" method="post" enctype="multipart/form-data">
                    <div class="form-main">
                                ...
                                <div class="form-group">
                                    <div class="form-col">
                                        <div class="form-input">
                                            ...
                                            <div class="input">
                                                <input type="text" name="pmc_Name" required>
                                            </div>
                                        </div>
                                        <div class="form-input">
                                            <label for="">說明</label>
                                            <div class="input">
                                                <input type="text" name="pmc_Desc" required>
                                            </div>
                                        </div>                                        
                                        <div class="form-input">
                                            <label for="">排序</label>
                                            <div class="input">
                                                <input type="text" name="pmc_Sort" required pattern="^[0-9]+$">
                                            </div>
                                        </div>
                                        <div class="form-input">
                                            <label for="">顯示</label>
