...
.wpb_wrapper.links a:hover {
    text-decoration: underline;
}
.special-links .submenu {
...
.special-links .has-submenu.active .submenu {
    display: block !important;
}

.special-links .has-submenu > a {
...
.special-links .has-submenu .fa-angle-down {
    transition: transform 0.3s ease;
}

.special-links .has-submenu.active .fa-angle-down {
...
document.addEventListener('DOMContentLoaded', function() {
    const menuItems = document.querySelectorAll('.special-links .has-submenu');
    ...
    <script type="text/javascript">
      ...
      window._wpemojiSettings = {
        ...
        source: {
          concatemoji:
            "https:\/\/industrial.themechampion.com\/wp-includes\/js\/wp-emoji-release.min.js?ver=6.7.1",
        },
      };
    ...
    <link
      ...
      href="../../wp-content/plugins/wp-video-lightbox/wp-video-lightbox.css?ver=6.7.1"
      type="text/css"
      media="all"
    />
    <link
      ...
      href="../../wp-content/plugins/vc-composer/assets/css/js_composer.min.css?ver=7.4"
      type="text/css"
      media="all"
    />
    ...
    <link
      ...
      href="../../wp-includes/css/dist/block-library/style.min.css?ver=6.7.1"
      type="text/css"
      media="all"
    />
    ...
    <link rel="shortlink" href="index.htm?p=45" />
    <link
      rel="alternate"
      title="oEmbed (JSON)"
      type="application/json+oembed"
      href="../../wp-json/oembed/1.0/embed-24?url=https%3A%2F%2Findustrial.themechampion.com%2Fservices%2Foil-and-lubricant%2F"
    />
    <link
      rel="alternate"
      title="oEmbed (XML)"
      type="text/xml+oembed"
      href="../../wp-json/oembed/1.0/embed-25?url=https%3A%2F%2Findustrial.themechampion.com%2Fservices%2Foil-and-lubricant%2F&#038;format=xml"
    />
  ...
  <body
    class="services-template-default single single-services postid-45 theme-industrial woocommerce-no-js header-tmc_header_1 header-fixed-on header-normal wpb-js-composer js-comp-ver-7.4 vc_responsive"
  >
  <div class="main-wrapper">
            ...
            <div class="col-lg-8 col-md-9 col-sm-12 col-xs-12 text-right">
              <div class="top-two-right">
                <div class="req-button text-right">
                  <a href="request-a-quote/index.htm" class="submit"
                    >請求報價</a
                  >
                </div>
                <div class="top-panel">
                      ...
                      <li class="item item-ad">
                        <div class="media">
                          <div class="blue-color media-left">
                            <a href="mailto:info@industx.com"
                        ...
                        <div class="widget-t widget-t-search">
                          <div class="widget-t-inner">
                            <form
                              ...
                              action="https://industrial.themechampion.com/"
                            >
                  ...
                  <div class="main-nav">
                      <ul id="Primary" class="nav navbar-nav">
                        ...
                        <li class="menu-item menu-item-has-children">
                          ...
                          <ul class="sub-menu">
                          <li class="menu-item">
                              <a href="<?= site_url('') ?>">電子連接元件</a>
                          </li>
                          <li class="menu-item">
                              <a href="<?= site_url('') ?>">大功率連接器</a>
                          </li>
                          <li class="menu-item">
                              <a href="<?= site_url('') ?>">電機控制元件</a>
                          </li>
                          <li class="menu-item">
                              <a href="<?= site_url('') ?>">工業及電子標示器材</a>
                          </li>
                          <li class="menu-item">
                              <a href="<?= site_url('') ?>">天線及高頻連接器</a>
                          </li>
                          <li class="menu-item">
                              <a href="<?= site_url('') ?>">SMD T&R零件帶裝</a>
                          </li>
                          </ul>
                        </li>
      ...
      <div class="breadcumb-wrapper">
        <div class="container clearfix">
			<span property="itemListElement" typeof="ListItem">
			  <a property="item" typeof="WebPage" title="Go to Industrial." href="../../index.htm" class="home">
			...
			<span property="itemListElement" typeof="ListItem">
			  <a property="item" typeof="WebPage" title="Go to Services." href="../index.htm" class="archive post-services-archive">
				<span property="name">公司產品</span>
			  </a>
			  <meta property="position" content="2" />
			</span>
			<span class="font-awe">&#xF105;</span>
			<span property="itemListElement" typeof="ListItem">
			  <a property="item" typeof="WebPage" title="Go to Oil and Lubricant." href="index.htm" class="post post-services">
				<span property="name">電子連接元件</span>
			  </a>
			  <meta property="position" content="3" />
			</span>
			<span class="font-awe">&#xF105;</span>
			<span property="itemListElement" typeof="ListItem">
			  <a property="item" typeof="WebPage" title="Go to Mobile Connection." href="index.htm" class="post post-services current-item" aria-current="page">
				<span property="name">行動電話連接元件</span>
			  </a>
          ...
          <div class="entry-content">
            <div class="wpb-content-wrapper">
              <div
                ...
                class="vc_row wpb_row vc_row-fluid single-service-page sectpad"
              >
                <div
                  class="single-side-left wpb_column vc_column_container vc_col-sm-4"
                >
                      ...
                      <div class="single-sidebar-widget">
                        <div class="special-links">
                          ...
                          <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li><a href="<?= site_url('products/category/mobile-parts') ?>">行動電話零件系列</a></li>
                                    <li><a href="<?= site_url('products/category/rf-cable') ?>">高頻線材組裝</a></li>
                                </ul>
                            </li>
                            <li>
                              <a href="../oil-and-lubricant/index.htm"
                                >高頻同軸連接元件</a
                              >
                            </li>
                            <li>
                              <a href="../meterial-engineering/index.htm"
                                >IC 插座</a
                              >
                            </li>
                            <li>
                              <a href="../mechanical-engineering/index.htm"
                                >PoGo Pin 接點連接器</a
                              >
                            </li>
                            <li>
                              <a href="../chemical-research/index.htm"
                                >通信面板夾線端子</a
                              >
                            </li>
                            <li>
                              <a href="../alternate-energy/index.htm"
                                >電路板連接元件</a
                              >
                            </li>
                            <li>
                              <a href="../agricultural-processing/index.htm"
                                >RJ45 網路連接器</a
                              >
                            </li>
                          </ul>
                ...
                <div
                  class="content-right pull-right tab-content wpb_column vc_column_container vc_col-sm-8"
                >
				<div class="vc_column-inner">
					<div class="wpb_wrapper">
											...
											<figure class="wpb_wrapper vc_figure">
												<div class="vc_single_image-wrapper vc_box_border_grey">
													<img fetchpriority="high" 
														 ...
														 width="1200" 
														 height="150" 
														 src="/public/images/products/03-2/section_img.png" 
														 class="vc_single_image-img attachment-full" 
														 alt="RF Components Banner" />
												</div>
											</figure>
										</div>
									</div>
						...
						<div class="vc_row wpb_row vc_inner vc_row-fluid">
							<div class="wpb_column vc_column_container vc_col-sm-12">
								<div class="vc_column-inner">
									<div class="wpb_wrapper">
										<!-- Main title -->
                                        <h2 class="wpb_heading" style="color: #666; border-bottom: 2px solid #ffc107; padding-bottom: 10px; margin-bottom: 20px; font-size: 27px;">行動電話連接元件 COMPONENTS FOR MOBILE DEVICES</h2>
										
										<!-- Subtitle -->
										<h3 class="wpb_heading" style="color: #666; font-weight: normal; margin-bottom: 20px;">RF switches & accessoires</h3>
														...
														<div class="wpb_single_image wpb_content_element vc_align_center">
															<figure class="wpb_wrapper vc_figure">
																<div class="vc_single_image-wrapper vc_box_border_grey" style="border: 1px solid #ddd; padding: 10px;">
																	<img width="200" 
																		 height="200" 
																		 src="/public/images/products/03-2/img_01.png" 
										...
										<div class="wpb_wrapper links">
                                            <a href="#" style="color: #0066cc; text-decoration: underline; margin-right: 15px;">數據表下載</a> 
                                            <a href="#" style="color: #0066cc; text-decoration: underline;">圖下載</a>
                                        </div>
										</div>
									</div>
								</div>
    ...
    <div class="clear"></div>
    <section
      class="indurial-t-solution indurial-solution indpad anim-5-all indurial-t-solution3"
    >
      <div class="container clearfix">
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="indurial-solution-text text-center">
              <h2>如果您需要任何工業解決方案...我們隨時為您服務</h2>
              <span class="contactus-button2 text-center">
                <a href="../contact-us/index.htm" class="submit">聯絡我們 </a>
              </span>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="sidebar-footer footer-columns footer-4-columns clearfix">
            ...
            >
              <aside
                id="ind_about-1"
                class="widget widget_ind_about about-us-widget"
              >
                <a href="index.htm" title="Industrial" rel="home">
            ...
            >
              <aside
                id="ind_services-1"
                class="widget widget_ind_services widget-links"
              >
                <h4 class="widget_title">公司產品</h4>
                <div class="widget-contact-list row m0">
                  <ul>
                    <li>
                      <a href="services/power-and-energy/index.htm"
                        >- 電子連接元件</a
                      >
                    </li>
                    <li>
                      <a href="services/oil-and-lubricant/index.htm"
                        >- 大功率連接器</a
                      >
                    </li>
                    <li>
                      <a href="services/meterial-engineering/index.htm"
                        >- 電機控制元件</a
                      >
                    </li>
                    <li>
                      <a href="services/mechanical-engineering/index.htm"
                        >- 工業及電子標示器材</a
                      >
                    </li>
                    <li>
                      <a href="services/chemical-research/index.htm"
                        >- 天線及高頻連接器</a
                      >
                    </li>
                    <li>
                      <a href="services/alternate-energy/index.htm"
                        >- SMD T&R零件帶裝</a
                      >
                    </li>
                    <li>
            ...
            >
              <aside
                id="nav_menu-1"
                class="widget widget_nav_menu widget-links"
              >
              <div class="widget-contact-list row m0">
                  <h4 class="widget_title">問題</h4>
            ...
            >
              <aside
                id="ind_get_in_touch-1"
                class="widget widget_ind_get_in_touch widget-contact"
              >
                <h4 class="widget_title">關於英碩</h4>
                <div class="widget-contact-list row m0">
                  <ul>
                    <li>
                    ...
                    <li>
                      ...
                      <div class="fleft contact_mail">
                        <a href="mailto:info@invax.com.tw">info@invax.com.tw</a>
                      </div>
                    </li>
                    <li>
    ...
    <div class="footer-t-bottom footer-bottom footer-bottom3">
      <div class="thm-container clearfix">
        <div class="pull-left fo-txt">Copyright © 2025 Invax.</div>
        <div class="pull-right fo-txt">
          <p class="designby">
            Developed by
            <a href="https://themeforest.net/user/themechampion">
              MID Technologies Co., Ltd</a
            >
          </p>
        </div>
      </div>
    ...
    <script type="text/javascript" id="wc-order-attribution-js-extra">
      ...
      var wc_order_attribution = {
        params: {
          ...
          base64: false,
          ajaxurl:
            "https:\/\/industrial.themechampion.com\/wp-admin\/admin-ajax.php",
...
<!-- Page supported by LiteSpeed Cache 6.5.4 on 2025-02-10 03:36:58 -->
